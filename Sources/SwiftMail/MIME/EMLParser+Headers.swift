...
extension EMLParser {
    ...
    static func buildMessageInfo(from headers: [String: String]) -> MessageInfo {
        ...
        return MessageInfo(
            ...
            cc: cc,
            bcc: bcc,
            fromAddress: parseStructuredAddressList(headers["from"]).first,
            toAddresses: parseStructuredAddressList(headers["to"]),
            ccAddresses: parseStructuredAddressList(headers["cc"]),
            bccAddresses: parseStructuredAddressList(headers["bcc"]),
            date: date,
            messageId: messageId,
            flags: [],
            parts: [],
